...
export function ModuleCard({ module, isCompleted, onOpen }: ModuleCardProps) {
  ...
  return (
    <article
      className={`rounded-2xl border p-4 transition hover:brightness-110 ${isLight ? "border-[#202020]/12 bg-white/78" : "border-white/15"}`}
      style={!isLight ? { backgroundColor: "#272D3F" } : undefined}
    >
